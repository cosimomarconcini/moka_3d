...
- Jun 03, 2026 -- Added radius info to FITS table output of per-shell kinematic properties after grid-search fitting 
               -- Added PV diagram output .png for pure disc fit mode
               -- Added radial profile output plot for outflow energetic properties
               -- Added possibility to give in input either a 2D electron density map or M/L conversion factor map to derive outflow energetic properties 
